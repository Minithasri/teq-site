  ...
  const data = [
    {
      ...
      description: 'A flexible, modular platform that lets you design, run, monitor, and manage agents end-to-end — all in one place, without dealing with complex integrations or scattered tools.'
    },
    {
      id: 2,
