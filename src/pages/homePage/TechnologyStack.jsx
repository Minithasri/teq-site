  ...
  const renderMobileStacked = () => (
    <div className='flex flex-col gap-6 w-full'>
      {cardData.map(card => (
        <div
          key={card.title}
          className='bg-white rounded-2xl p-4 shadow-xl flex flex-col gap-4 w-full'
        >
          <div className='p-2 flex flex-col h-full'>
            <div
              className='bg-gray-50 rounded-[5px] p-5 flex flex-col gap-3 min-h-[290px]'
              style={{ border: '1px solid #E5E5E5' }}
            >
              <div className='flex gap-2 items-center'>
                <div className='bg-white p-3 rounded-xl flex items-center justify-center w-14 h-14 min-w-14'>
              ...
              <div
                className='text-sm px-4 py-2 w-36 h-8 flex items-center justify-center rounded-[5px] mt-4 bg-white font-medium'
                style={{ border: '1px solid #E5E5E5', color: '#404040' }}
              >
                {card.count}
              </div>
            </div>
