          ...
          >
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                {/* Custom tile div */}
                <div
                  className="flex items-center bg-transparent border border-[#804599] rounded-[12px]"
                  style={{
                    width: "285px",
                    height: "45px",
                  }}
                >
                  {/* SNO column - border removed */}
                  <div
              ...
              {isOpened && (
                <div className="pb-5 text-[16px]" style={{ color: textColor }}>
                  {item.content}
                </div>
              )}
            </div>
