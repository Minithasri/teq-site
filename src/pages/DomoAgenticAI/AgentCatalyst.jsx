...
const AgentCatalyst = () => {
  return (
    <div className="px-4 sm:px-6 md:px-8 lg:px-10 flex justify-center my-8 sm:my-12 md:my-16 lg:my-20 xl:my-[80px]">
      <div
        className="bg-gradient-to-br from-[#7030B1] to-[#A545CC] rounded-2xl sm:rounded-[25px] relative overflow-hidden w-full max-w-[1200px]"
      >
        {/* Background Image */}
        ...
        <div className="relative z-20 flex flex-col lg:flex-row h-auto min-h-[350px] sm:min-h-[400px] md:min-h-[450px] lg:h-[470px]">
            ...
            <div className="mb-6 sm:mb-8 flex justify-center lg:justify-start">
              ...
              ">
                ...
                <div className="w-[85px] h-[32px] sm:w-[95px] sm:h-[38px] md:w-[110px] md:h-[45px] bg-white rounded-full flex items-center justify-center shrink-0">
                  <span className="text-[#F16B66] font-bold text-[13px] sm:text-[15px] md:text-[18px] lg:text-[20px]">Build</span>
                </div>

                {/* CONNECTOR 1 - Mobile */}
                <div className="flex items-center shrink-0 sm:hidden">
                  <svg width="16" height="8">
                    <line x1="0" y1="4" x2="14" y2="4" stroke="white" strokeWidth="2" strokeDasharray="3 2" opacity="0.9" />
                  </svg>
                ...
                <div className="hidden sm:flex items-center shrink-0">
                  <svg width="30" height="8" className="md:w-[45px] md:h-[10px]">
                    <line x1="0" y1="4" x2="28" y2="4" stroke="white" strokeWidth="2" strokeDasharray="4 3" opacity="0.9" />
                  </svg>
                ...
                {/* PILL 2 */}
                <div className="w-[85px] h-[32px] sm:w-[95px] sm:h-[38px] md:w-[110px] md:h-[45px] bg-white rounded-full flex items-center justify-center shrink-0">
                  <span className="text-[#F16B66] font-bold text-[13px] sm:text-[15px] md:text-[18px] lg:text-[20px]">Deploy</span>
                </div>
                ...
                {/* PILL 3 */}
                <div className="w-[85px] h-[32px] sm:w-[95px] sm:h-[38px] md:w-[110px] md:h-[45px] bg-white rounded-full flex items-center justify-center shrink-0">
                  <span className="text-[#F16B66] font-bold text-[13px] sm:text-[15px] md:text-[18px] lg:text-[20px]">Scale</span>
                </div>
          ...
          <div className="hidden lg:flex flex-1 relative h-auto">
            ...
            {/* Desktop Images */}
            <div className="absolute -right-15 top-0 w-[700px]">
              <Image
            ...
            <div className="absolute right-0 w-[550px]">
              <Image
                src="/images/Ai.svg"
                alt="AI"
                width={500}
