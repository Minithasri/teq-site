  ...
  return (
    <section className='w-full py-16 lg:py-24'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        {/* Heading */}
        <h2
          className='text-center font-bold mb-12 lg:mb-16 bg-clip-text text-transparent leading-tight'
          style={{
        ...
        {/* Image Container */}
        <div className='relative w-full mb-8 lg:mb-12 flex justify-center'>
          <div
            className='relative rounded-3xl overflow-hidden shadow-2xl'
            style={{ width: '1240px', height: '260px' }}
          >
            <Image
        ...
        <div className='max-w-5xl mx-auto'>
          <p className='text-center text-gray-600 text-base lg:text-lg leading-relaxed'>
