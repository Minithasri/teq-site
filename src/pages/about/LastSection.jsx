        ...
        <div className='space-y-24'>
          {awards.map((item, index) => {
            ...
            return (
              ...
              >
                {/* --- IMAGE SECTION --- */}
                {/* Z-Index 20 to sit ON TOP of the card */}
                <div
                ...
                {/* --- CONTENT SECTION --- */}
                {/* Negative margin pulls this whole column under the image */}
                <div
                  className={`flex-1 relative z-10 w-full mt-8 lg:mt-12 ${
                    isImageLeft
                      ? 'lg:-ml-24 lg:mt-0' // Pull left for left-image layout
                      : 'lg:-mr-24 lg:mt-0' // Pull right for right-image layout
                  }`}
                >
                  {/* WRAPPER: Handles text offset to clear the image overlap */}
                  {/* We increase padding for the 3rd item because the image is wider */}
                  <div
                    className={`${
                      isImageLeft
                        ? isThirdItem
                          ? 'lg:pl-56' // Extra padding for wide 3rd image
                          : 'lg:pl-32' // Standard padding for left image
                        : 'lg:pr-32' // Standard padding for right image
                    }`}
                  >
