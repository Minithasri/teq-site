  ...
  return (
    <section className='w-full py-16 px-4 md:px-8 lg:px-16 xl:px-24'>
      <div className='max-w-7xl mx-auto flex mt-10 flex-col gap-12'>
        ...
        {/* Metrics Row */}
        <div
          className='relative flex flex-col md:flex-row justify-evenly w-full rounded-2xl mt-10 mb-10'
          style={{
            background:
              'linear-gradient(258.79deg, rgba(229, 170, 102, 0.144) -13.56%, rgba(255, 165, 129, 0.144) -13.56%, rgba(221, 161, 108, 0.144) 18.23%, rgba(230, 242, 246, 0.144) 53.64%, rgba(202, 185, 246, 0.144) 91.85%, rgba(112, 48, 177, 0.144) 119.62%)',
          }}
        >
          {/* Gradient Border via Mask (prevents purple show-through on transparent backgrounds) */}
          <div
