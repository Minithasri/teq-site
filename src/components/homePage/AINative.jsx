          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center'>
            ...
            <div className='flex flex-col justify-center'>
              ...
              <p className='text-[#737373] text-[10px] md:text-[12px] font-medium leading-[1.7] mb-5'>
                Founded by a team of AI researchers and enterprise engineers, Agent Forge exists to
                bridge the gap between cutting edge AI research and real world business impact. We
                don't just build chatbots we architect autonomous systems that reason, learn, and
                act.
              </p>
