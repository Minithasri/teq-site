...
export default function AboutGwc({ aboutData }) {
  ...
  return (
    <div className='w-full bg-[#FFFFFF] py-4 px-4 md:px-6 my-12'>
      <div className='max-w-7xl mx-auto'>
        <div
          className='rounded-3xl p-8 md:p-10 border border-[#ECEAE6] flex flex-col gap-4'
          style={{
            background:
        ...
        >
          {/* Tagline */}
          <span className='text-xs md:text-sm font-bold text-[#7C7C7C] uppercase tracking-widest font-sans'>
            {aboutData.tagline}
          </span>

          {/* Description Text */}
          <p className='text-sm md:text-base text-[#404040] font-sans font-regular leading-relaxed'>
            {aboutData.text}
          </p>
        </div>
      </div>
