      ...
      <div className='relative max-w-[1440px] mx-auto px-6 md:px-12 lg:px-24 mb-12'>
        <div className='flex flex-col items-center relative z-10'>
          ...
          <div className='text-center mb-12 relative z-20'>
            <h2 className='text-[#000000] font-bold text-lg md:text-2xl lg:text-4xl uppercase tracking-widest mb-8'>
              SOLUTION APPROACH
            </h2>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10'>
          {solutionSteps.map((step, index) => (
            <div key={index} className='flex flex-col'>
              <div className='bg-white rounded-[24px] p-8 border-[2px] border-[#1E0BF199] shadow-md relative hover:shadow-lg transition-all'>
                {/* Top Row: Category Pill + Number */}
                <div className='flex justify-between items-center mb-6'>
                  <div className='px-4 py-1 rounded-full border border-[#1E0BF1] bg-[#259D911A] text-[#1E0BF1] text-[10px] md:text-xs font-bold uppercase tracking-wider'>
                    {step.category}
                  </div>
                  <div className='w-8 h-8 rounded-full border border-[#1E0BF1] flex items-center justify-center text-[#1E0BF1] text-sm font-bold'>
                    {step.id}
                  </div>
                </div>
