  ...
  return (
    ...
    >
      ...
      <div className='w-full max-w-[1440px] mx-auto px-6 sm:px-10 md:px-16 lg:px-24 relative z-10'>
        {/* Title */}
        <h1
          className='text-3xl sm:text-4xl md:text-5xl lg:text-[48px] font-bold leading-tight mb-8 max-w-7xl tracking-tight'
        ...
        >
          Migrating complex data workloads and operational Magic ETL logic from Domo to Snowflake to
          deliver a scalable, cost-efficient, and highly flexible cloud architecture.
        </p>
      </div>
    </section>
  );
