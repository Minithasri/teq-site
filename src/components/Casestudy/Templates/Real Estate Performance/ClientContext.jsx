...
export default function ClientContext() {
  return (
    ...
    >
      {/* 1. Muted Background Architecture Image */}
      ...
      <div className='relative z-10 w-full max-w-[100%] mx-auto h-full flex flex-col pt-10 md:pt-12 pb-10'>
        {/* 2. Section Header: Client Context */}
        <h2
        ...
        >
          <span className='text-[28px] sm:text-[30px] md:text-[34px]'>Client Context</span>
        </h2>

        {/* Content Layout Frame: Content Card & Floating Model */}
        <div className='w-full flex items-center justify-between relative mt-2 md:mt-4'>
          {/* 3 & 4. Left Text Container and Content Text */}
          <div
            className='w-full max-w-[950px] rounded-2xl p-5 sm:p-6 md:p-10 ml-0 md:ml-20 z-10 relative'
            style={{
          ...
          {/* 5. Right Side Floating 3D City Mini-Model */}
          <div
            className='absolute right-2 md:right-[-170px] top-1/2 -translate-y-1/2 z-20 hidden lg:block pointer-events-none'
            style={{
              width: '605px',
              height: '363px',
              opacity: 0.94,
