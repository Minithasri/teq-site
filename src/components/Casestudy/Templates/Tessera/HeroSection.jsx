...
const HeroSection = () => {
  return (
    <section className='relative w-full h-[60vh] sm:h-[70vh] md:h-[60vh] flex items-center justify-start overflow-hidden'>
      {/* Background Image */}
      ...
      <div className='relative z-20 w-full max-w-[1440px] mx-auto px-6 sm:px-10 md:px-16 lg:px-24 flex flex-col justify-center h-full text-left'>
        <div className='max-w-7xl'>
          ...
          <p className='text-white text-sm sm:text-base md:text-[16px] lg:text-[18px] font-normal leading-relaxed opacity-95 max-w-7xl'>
