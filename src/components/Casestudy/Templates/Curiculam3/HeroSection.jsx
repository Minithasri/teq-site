  ...
  return (
    ...
    >
      ...
      <div className='w-full max-w-[1440px] mx-auto px-6 sm:px-10 md:px-16 lg:px-24 relative z-10'>
        {/* Title */}
        <h1
          className='text-3xl sm:text-4xl md:text-5xl lg:text-[54px] font-bold leading-tight mb-8 max-w-7xl tracking-tight'
        ...
        {/* Subtext Description */}
        <p
          className='text-sm sm:text-base md:text-lg lg:text-[18px] leading-relaxed max-w-7xl font-light'
          style={{
            color: '#FFFFFFB2',
        ...
        >
          Migrating dynamic reports from Tableau to Power BI to deliver a centralized, governed, and
          highly performant business intelligence infrastructure.
        </p>
      </div>
    </section>
  );
