            ...
            {challengeCards.map((item, index) => (
              ...
              >
                ...
                <div className='flex items-center gap-4'>
                  {/* ICON BOX */}
                  <div className='flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-[14px] bg-red-500/10 '>
                    <Image
                      src={item.icon}
                      alt={item.title}
                      width={22}
                  ...
                  {/* TITLE */}
                  <h3 className='text-[12px] md:text-[16px] leading-[1.45] font-semibold tracking-[-0.4px] text-[#0F1729]/80'>
                    {item.title}
                  </h3>
                </div>
