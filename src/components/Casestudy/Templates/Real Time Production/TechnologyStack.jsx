      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='space-y-4'>
          {stack.map((item, index) => (
            <div key={index} className='flex items-center gap-6 max-w-6xl'>
              {/* Card */}
              <div className='flex-1 bg-white border border-gray-100 rounded-xl p-4 sm:p-6 shadow-sm grid grid-cols-2 items-center'>
              ...
              {/* Icon */}
              <div className='flex-shrink-0 w-20 h-20 lg:w-24 lg:h-24 relative'>
