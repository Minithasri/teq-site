...
const techStack = ['Domo (Code Engine)', 'AppDB', 'Datasets', 'React.js'];
...
const businessImpact = [
  ...
  {
    bold: '',
    text: 'Better consistency across systems',
  },
  {
    bold: '',
    text: 'Full traceability enabled',
  },
];
  ...
  return (
    <section className='relative w-full overflow-hidden'>
      ...
      <div className='absolute right-0 bottom-20 hidden md:block'>
        <Image
          src='/images/Templates/take2eton-4/business-impact.png'
          alt='Travel'
          width={430}
          height={260}
          priority
        ...
        <div>
          ...
          <div className='flex flex-col md:flex-row gap-6'>
            ...
            <div className='flex flex-wrap gap-6'>
              <Image
                src='/images/Templates/take2eton-4/domo.png'
                alt='Domo'
                width={52}
                height={52}
              ...
              <Image
                src='/images/Templates/take2eton-4/react.png'
                alt='Python'
                width={52}
                height={52}
                className='h-[52px] w-[52px] object-contain'
