  ...
  return (
    ...
    >
      <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <h2 className='text-[24px] md:text-[28px] font-semibold tracking-[1.4px] text-[#E71013] text-center uppercase mb-8 md:mb-10 leading-tight'>
          The Challenge
        </h2>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6'>
          {challenges.map((item, index) => (
            <div
              key={index}
              className='bg-white border-[1px] border-[#E71013] rounded-xl p-5 flex items-start gap-4 shadow-sm'
            >
              {/* Icon Container */}
              <div className='flex-shrink-0 w-10 h-10 rounded-[8px] bg-[#FBD8D9] border border-[#E71013] flex items-center justify-center'>
                {item.icon}
              </div>

              {/* Text Content */}
              <div className='flex flex-col justify-center'>
                <h3 className='text-[16px] md:text-[18px] font-bold text-[#E71013] mb-1 leading-tight'>
                  {item.title}
                </h3>
