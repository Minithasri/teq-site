...
const bannerContent = {
  breadcrumb: {
    items: [
      { label: 'Home', href: '/' },
      { label: 'AI FinOps & Token Economics', href: '/solutions/ai-finops' },
    ],
  },
  title: 'AI FinOps & Token Economics',
  description:
    'GWC brings financial discipline to AI spend, turning every token, model call, and workflow into measurable ROI.',
  ctaText: 'Talk to a FinOps Specialist',
  images: {
    background: '/images/solutions/dataStrategyEngineer/data_hero.webp',
    illustration: '/images/solutions/aifinops/frame1.png',
  },
};
    ...
    <header className='relative w-full overflow-hidden pt-[60px]'>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 lg:pt-14 pb-12'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-[55%_45%] items-center gap-12 lg:gap-16'>
          ...
          <div>
            <h1
              className='text-[32px] md:text-[42px] font-semibold max-w-[600px] mb-4 lg:-mt-20'
              style={{ color: '#404040', lineHeight: '52px' }}
            >
              AI FinOps & <span style={{ color: '#6F2B8B' }}>Token Economics</span>
            </h1>
            ...
            <Link
              href='/contact'
              className='inline-flex items-center gap-2 bg-gradient-to-r from-[#7030B1] to-[#B56DD3] text-white px-6 h-[45px] rounded-full font-medium text-[15px] justify-center hover:scale-105 transition-transform shadow-lg'
            >
          ...
          <div className='relative w-full max-w-[500px] mx-auto lg:mx-0'>
            <Image
              ...
              alt='AI FinOps & Token Economics illustration'
              width={400}
              height={340}
              priority
