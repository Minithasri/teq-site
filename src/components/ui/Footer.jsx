...
const Footer = () => {
  ...
  return (
    <footer
      style={{
        background: 'linear-gradient(135deg, #2E123B 0%, #5A1F6F 100%)',
        color: '#ffffff',
    ...
    >
      <div className='max-w-7xl mx-auto px-8 lg:px-12 py-12'>
          ...
          <div className='lg:col-span-1'>
            <div className='mb-6'>
              <img
                ...
                className='w-[240px] h-[65px] object-contain'
              />
            </div>
            <p className='text-sm leading-relaxed mb-8 opacity-90'>
              We ensure better services and better quality at every product you might be interested
              in and we shall help grow better.
            </p>
            ...
            <div className='space-y-4'>
              ...
              <div className='flex items-center gap-3'>
                ...
                <div className='text-sm opacity-90'>
                  <div>+91 95914 33122 | +91 99861 68512</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='flex items-center gap-4 mb-8 pb-8 border-b border-white border-opacity-20'>
          <div className='text-sm opacity-80'>Follow us on</div>
          <div className='flex gap-4'>
            <a
              href='#'
              className='w-10 h-10 flex items-center justify-center border border-white border-opacity-30 rounded hover:bg-white hover:bg-opacity-10 transition-all duration-300'
            >
