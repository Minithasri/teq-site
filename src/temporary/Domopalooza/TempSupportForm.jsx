  ...
  return (
    <>
      ...
      <div className='bg-white rounded-2xl sm:rounded-3xl shadow-[0_16px_32px_-8px_rgba(0,0,0,0.1)] border border-gray-100 p-4 sm:p-6 h-full overflow-y-auto'>
        {/* Header bar */}
        <div className='bg-[#F9F3FB] rounded-2xl p-4 mb-5 flex items-center gap-3 border border-[#F5F0FF]'>
          <div className='w-10 h-10 bg-gradient-to-b from-[#7030B1] to-[#B56DD3] rounded-xl flex items-center justify-center shadow-lg flex-shrink-0'>
          ...
          <div>
            ...
            <p className='text-md text-gray-500 font-medium'>Get expert help for your use case</p>
          </div>
        </div>
        ...
        <div className='space-y-4'>
          ...
          <button
            ...
            className='group relative w-full overflow-hidden rounded-full bg-gradient-to-b from-[#7030B1] to-[#B56DD3] px-6 py-3 text-base font-bold text-white shadow-[0_5px_15px_-5px_rgba(139,92,246,0.5)] transition-all active:scale-[0.98] disabled:opacity-70 disabled:grayscale disabled:cursor-not-allowed'
          >
            {loading ? (
        ...
        createPortal(
          ...
          >
            <div className='bg-white rounded-2xl max-w-2xl w-full mx-auto shadow-2xl transform animate-slideUp border border-gray-100 max-h-[70vh] flex flex-col relative overflow-hidden'>
              ...
              {/* Scrollable content */}
              <div className='overflow-y-auto flex-1' style={{ zIndex: 10 }}>
...
export default TempSupportForm;
